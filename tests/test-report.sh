...
grep -Fqx "# RepoMux run report" "$complete_report"
grep -Fqx "**Repository work:** 🟢 **Completed**" "$complete_report"
...
grep -Fqx 'The fake repository agent completed the task\.' "$complete_report"
grep -Fqx -- '- 🟢 **Passed** - ` fake test `: Passed\.' "$complete_report"
...
grep -Fqx "## Next actions" "$complete_report"
...
grep -A12 -F '## Repository: ` api `' "$complete_report" | grep -Fqx "**Integration:** 🟢 **Integrated**"
...
grep -Fqx "⚪ **Unavailable**" "$complete_report"
...
grep -Fqx "**Repository work:** 🔴 **Incomplete**" "$complete_report"
grep -Fqx "**Incomplete repositories:** api" "$complete_report"
grep -A2 -F '## Repository: ` api `' "$complete_report" | grep -Fqx "**Status:** 🔴 **Failed**"
...
grep -A2 -F '## Repository: ` api `' "$complete_report" | grep -Fqx "**Status:** 🟡 **Blocked**"
...
grep -A2 -F '## Repository: ` api `' "$complete_report" | grep -Fqx "**Status:** 🔴 **Missing**"
